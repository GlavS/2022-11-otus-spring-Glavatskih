...
class StudentServiceImplTest {
    ...
    @Mock
    private LocalizedStudentServiceMessageStorage storage;
    ...
    void registerMethodShouldReturnStudentInstance() {
        ...
        when(storage.getRegisterFirstNamePrompt()).thenReturn("First name prompt");
        when(storage.getRegisterLastNamePrompt()).thenReturn("Last name prompt");
