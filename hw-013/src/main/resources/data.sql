...
VALUES ('admin', '{bcrypt}$2a$10$fqh.Y/YYMOlqoZ3.0J5FleKvUDbSzNsqUtrPadIyOunQcbxgTWbXm', 'ROLE_ADMIN'), --"password"
       ('user', '{bcrypt}$2a$10$c68rgBbWWoZQKJwuwN7auukRs4a/QyTSOn9854nFdqwFwUZLywnSq', 'ROLE_USER'); -- "userpass"
